...
public class StudyWriteCtrl extends HttpServlet {
	private static final long serialVersionUID = 1L;
	public StudyWriteCtrl() {
		super();
	}
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		Study vo = new Study();
		String stag = mReq.getParameter("stag");
		
		vo.setSsubject(mReq.getParameter("ssubject"));
		vo.setScontent(mReq.getParameter("scontent"));
		vo.setStag(Integer.parseInt(stag));
		vo.setSwriter(swriter);
		vo.setSfilepath(fileNames);
		
		int result = 0;
		try {
			result = new StudyService().studyWrite(vo);
