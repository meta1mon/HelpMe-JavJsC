...
public class ShopvideoDAO {
	...
	public int managerCheck(Connection conn, String id, String passwd) throws Exception {
	...
	public List<VideoVO> getVideos(Connection conn, String vkind) throws SQLException {
	...
	// 비디오 삭제
	public int deleteVideo(Connection conn, int vid) throws Exception {
		int result = 0;
