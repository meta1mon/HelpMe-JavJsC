...
<body class="content">
	...
	<div style="width: 800px; margin: 0 auto 0 auto;">
		<h1>글쓰기</h1>
		<form action="<%=request.getContextPath()%>/studyupdate" method="post"
			...
			<div style="margin-bottom:10px;">
				<input style="width: 800px; height: 40px; font-size: 15px; box-sizing: border-box;"
					type="text" placeholder="글 제목" name="ssubject" maxlength="100" value="${study.ssubject }">
			</div>
			<div style="margin-bottom:10px;">
				<select name="stag" style="width: 800px; height: 40px; font-size: 15px;">
			...
			<div style="margin-bottom:10px;">
				<textarea placeholder="글 내용" id="editor" name="scontent"
					maxlength="4000">${study.scontent }</textarea>
			</div>
			...
			<div>
				<input type="submit" value="등록"> <input type="button"
					value="취소"
					onclick="location.href = '<%=request.getContextPath()%>/studylist'">
			</div>
		</form>
	</div>
	</div>
