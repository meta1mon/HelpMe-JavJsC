...
<body class="content">
	<div style="width: 800px; margin: 0 auto 0 auto;">
		...
		<form action="<%=request.getContextPath()%>/qnaupdate" method="post"
			...
			<img src="<%=request.getContextPath()%>/images/folder.png" id="folder">
			<br><div style="display:inline; position:relative; top:10px; left:213px;">글 수정 시 기존에 첨부했던 파일은 삭제됩니다.</div><br>
						<div  style="display:inline; position:relative; top:10px; left:180px;" >기존 첨부 파일 :
