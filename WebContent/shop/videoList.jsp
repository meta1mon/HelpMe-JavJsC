...
<body>
	...
	<table border="2">
		<tr>
			...
			<a href="<%=request.getContextPath() %>/videoupdateForm?vid=${v.vid}&vkind=${v.vkind}">수정</a></td>
			<td width="50" style="text-decoration: underline;">
			<a href="<%=request.getContextPath() %>/videodeleteForm?vid=${v.vid}&vkind=${v.vkind}">삭제</a></td>
			</tr>
			</c:forEach>
