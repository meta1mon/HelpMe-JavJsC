...
<body>
		...
		<c:forEach items="${rlist }" var='r'>
			<tr style="border-bottom: 1px solid #eeeeee;">
				<td style="width:50px; font-size:14px;"><a style="font-size:18px;">${r.rviewcnt }</a><br>조회</td>
				<td style="width:50px;"><a style="font-size:18px;">${r.rlikecnt }</a><br>좋아요</td>
				<td style="width:50px;"><a style="font-size:18px;">${r.rreviewcnt }</a><br>답변</td>
				<td style="text-align: left; width:450px;">
					<a href="reviewread?rno=${r.rno}" id="subject">${r.rsubject }</a> 
						<br> 
								<c:choose>
				...
				<td><a style="color:#0054FF; text-align: left;">${r.rwriter }</a> <br> <a style="font-size:13px;">${r.rdate }</a></td>
			</tr>
		</c:forEach>
		</table>
</body>
